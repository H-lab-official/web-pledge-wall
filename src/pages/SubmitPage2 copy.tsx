...
const SubmitPage = () => {
  ...
  const backgroundSVG = useMemo(() => (
    <div className="pointer-events-none absolute inset-0 w-full h-full" style={{ opacity: isTransitioningToSuccess ? 0 : 1 }}>
      <svg
        width="100%"
        height="100%"
      ...
      {/* Animated Waves */}
      <div className="wave-background absolute bottom-0 left-0 right-0" style={{ transform: 'translate(0, 720px)' }}>
        <svg
          width="100%"
          height="100%"
