...
export const API_CONFIG = {
  ...
  LOCAL_API_URL: 'http://192.168.88.51:3001/api', // เปลี่ยนจาก localhost เป็น IP จริง
  
  // Backup server (สำหรับกรณี Firebase ล้มเหลวหรือช้าเกินไป)
  // ⚙️ เปลี่ยน IP/URL นี้เป็นของคุณ
  BACKUP_API_URL: 'http://192.168.88.51:3001/api', // เปลี่ยนเป็น IP ของ backup server
